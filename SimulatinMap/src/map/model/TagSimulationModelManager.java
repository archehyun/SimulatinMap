	...
	public TableModel createPointListTableModel() {
		...
		for(int i=0;i<pointList.size();i++)
		{
			if(i<pointList.size()-1)
			{
				...
				double angle = Distance.getAngle(point1.getX(), point1.getY(), point2.getX(), point2.getY());
				double distance = Distance.getDistance(point1.getX(), point1.getY(), point2.getX(), point2.getY());
...
/*						String.format("%.1f", angle),
	...
	public DefaultTableModel createPointMoveTableModel() {
		...
		System.out.println("movesize:"+pointMoveList.size());
